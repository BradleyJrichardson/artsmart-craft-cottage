      ...
      <React.Fragment>
        <div className=" footer">
          <div className = 'row'>
            ...
            <div className = 'col-sm-12 col-md-3 p-2 d-flex justify-content-center align-items-md-center' style ={{backgroundColor: 'rgba(134, 185, 181, 0.733)'}}><ContactMeForm /></div>
          </div>
        </div>
      </React.Fragment>
    );
